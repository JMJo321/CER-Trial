...
# #   hourly ATEs. And then save the regression results in .RData format.
# #   This script needs about 20 minutes to run all regressions.
  ...
  save(
    ...
    file = paste(
      ...
      paste0(
        ...
        "Hourly-in-the-Peak-Rate-Period_Quadratic-Model_",
